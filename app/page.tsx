...
const containerVariants = {
  ...
  visible: {
    opacity: 1,
    transition: {
      staggerChildren: 0.1, // délai entre chaque element
      delayChildren: 0.2,   // Délai de 0.2s 
    }
  }
}

// Configuration des animations pour les éléments individuels
// appartition effet de translation depuis le bas (y: 20)
const itemVariants = {
  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        {/* Section liens - Affiche les liens dans une grille  */}
        <motion.section 
